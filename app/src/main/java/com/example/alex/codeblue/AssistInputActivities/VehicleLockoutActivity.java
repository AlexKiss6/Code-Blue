 ...
 */
public class VehicleLockoutActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vehicle_lockout);
    ...
    private void sendEmail() {
        ...
        String subject = "Vehicle Lockout Request";
        ...
        String body = "Ticket Type:  Vehicle Lockout" +
                "\n\nCar Make:  " + carMake +
                "\nCar Model:  " + carModel +
                "\nCar Color:  " + carColor +
